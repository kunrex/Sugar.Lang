...
namespace Analysis::Structure::Context
{
    ...
    string PrintContext::CILInstruction() const { return std::format("{}()", ln ? cil_write : cil_write_line); }
    ...
    string PrintCharContext::CILInstruction() const { return std::format("{}(char)", ln ? cil_write : cil_write_line); }
    ...
    string PrintBoolContext::CILInstruction() const { return std::format("{}(bool)", ln ? cil_write : cil_write_line); }
    ...
    string PrintShortContext::CILInstruction() const { return std::format("{}(int16)", ln ? cil_write : cil_write_line); }
    ...
    string PrintIntContext::CILInstruction() const { return std::format("{}(int32)", ln ? cil_write : cil_write_line); }
    ...
    string PrintLongContext::CILInstruction() const { return std::format("{}(int64)", ln ? cil_write : cil_write_line); }
    ...
    string PrintFloatContext::CILInstruction() const { return std::format("{}(float32)", ln ? cil_write : cil_write_line); }
    ...
    string PrintDoubleContext::CILInstruction() const { return std::format("{}(float64)", ln ? cil_write : cil_write_line); }
    ...
    string PrintStringContext::CILInstruction() const { return std::format("{}(string)", ln ? cil_write : cil_write_line); }
    ...
    string PrintObjectContext::CILInstruction() const { return std::format("{}(object)", ln ? cil_write : cil_write_line); }
}
