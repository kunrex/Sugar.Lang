...
namespace Analysis::Structure::Wrappers
{
    ...
    void Math::BindGlobal()
    {
        ...
        functions[0] = { std::hash<string>()("Abs") ^ ArgumentHash(abs), abs };
        ...
        max->PushParameterType(Double::Instance());
        functions[1] = { std::hash<string>()("Max") ^ ArgumentHash(max), max };
        ...
        min->PushParameterType(Double::Instance());
        functions[2] = { std::hash<string>()("Min") ^ ArgumentHash(min), min };
        ...
        functions[3] = { std::hash<string>()("Sign") ^ ArgumentHash(sign), sign };
        ...
        functions[4] = { std::hash<string>()("Sqrt") ^ ArgumentHash(sqrt), sqrt };
        ...
        pow->PushParameterType(Double::Instance());
        functions[5] = { std::hash<string>()("Pow") ^ ArgumentHash(pow), pow };
        ...
        functions[6] = { std::hash<string>()("Exp") ^ ArgumentHash(exp), exp };
        ...
        functions[7] = { std::hash<string>()("Sin") ^ ArgumentHash(sin), sin };
        ...
        functions[8] = { std::hash<string>()("Cos") ^ ArgumentHash(cos), cos };
        ...
        functions[9] = { std::hash<string>()("Tan") ^ ArgumentHash(tan), tan };
        ...
        functions[10] = { std::hash<string>()("Asin") ^ ArgumentHash(asin), asin };
        ...
        functions[11] = { std::hash<string>()("Acos") ^ ArgumentHash(acos), acos };
        ...
        functions[12] = { std::hash<string>()("Atan") ^ ArgumentHash(atan), atan };
        ...
        functions[13] = { std::hash<string>()("Sinh") ^ ArgumentHash(sinh), sinh };
        ...
        functions[14] = { std::hash<string>()("Cosh") ^ ArgumentHash(cosh), cosh };
        ...
        functions[15] = { std::hash<string>()("Tanh") ^ ArgumentHash(tanh), tanh };
        ...
        functions[16] = { std::hash<string>()("Log") ^ ArgumentHash(ln), ln };
        ...
        log->PushParameterType(Double::Instance());
        functions[17] = { std::hash<string>()("Log") ^ ArgumentHash(log), log };
        ...
        functions[18] = { std::hash<string>()("Round") ^ ArgumentHash(round), round };
        ...
        functions[19] = { std::hash<string>()("Ceil") ^ ArgumentHash(ceil), ceil };
        ...
        functions[20] = { std::hash<string>()("Floor") ^ ArgumentHash(floor), floor };
    }
