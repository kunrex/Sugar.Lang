...
namespace Analysis::Structure::Wrappers
{
    ...
    {
        characteristics.push_back(new BuiltInConstant("E", Describer::Public | Describer::Constexpr, Double::Instance(), new DoubleConstant(M_E)));
        characteristics.push_back(new BuiltInConstant("PI", Describer::Public | Describer::Constexpr, Double::Instance(), new DoubleConstant(M_PI)));
        ...
        functions.emplace_back(std::hash<string>()("Abs") ^ ArgumentHash(abs), abs);
        ...
        max->PushParameterType(Double::Instance());
        functions.emplace_back(std::hash<string>()("Max") ^ ArgumentHash(max), max);
        ...
        min->PushParameterType(Double::Instance());
        functions.emplace_back(std::hash<string>()("Min") ^ ArgumentHash(min), min);
        ...
        functions.emplace_back(std::hash<string>()("Sign") ^ ArgumentHash(sign), sign);
        ...
        functions.emplace_back(std::hash<string>()("Sqrt") ^ ArgumentHash(sqrt), sqrt);
        ...
        pow->PushParameterType(Double::Instance());
        functions.emplace_back(std::hash<string>()("Pow") ^ ArgumentHash(pow), pow);
        ...
        functions.emplace_back(std::hash<string>()("Exp") ^ ArgumentHash(exp), exp);
        ...
        functions.emplace_back(std::hash<string>()("Sin") ^ ArgumentHash(sin), sin);
        ...
        functions.emplace_back(std::hash<string>()("Cos") ^ ArgumentHash(cos), cos);
        ...
        functions.emplace_back(std::hash<string>()("Tan") ^ ArgumentHash(tan), tan);
        ...
        functions.emplace_back(std::hash<string>()("Asin") ^ ArgumentHash(asin), asin);
        ...
        functions.emplace_back(std::hash<string>()("Acos") ^ ArgumentHash(acos), acos);
        ...
        functions.emplace_back(std::hash<string>()("Atan") ^ ArgumentHash(atan), atan);
        ...
        functions.emplace_back(std::hash<string>()("Sinh") ^ ArgumentHash(sinh), sinh);
        ...
        functions.emplace_back(std::hash<string>()("Cosh") ^ ArgumentHash(cosh), cosh);
        ...
        functions.emplace_back(std::hash<string>()("Tanh") ^ ArgumentHash(tanh), tanh);
        ...
        functions.emplace_back(std::hash<string>()("Log") ^ ArgumentHash(ln), ln);
        ...
        log->PushParameterType(Double::Instance());
        functions.emplace_back(std::hash<string>()("Log") ^ ArgumentHash(log), log);
        ...
        functions.emplace_back(std::hash<string>()("Round") ^ ArgumentHash(round), round);
        ...
        functions.emplace_back(std::hash<string>()("Ceil") ^ ArgumentHash(ceil), ceil);
        ...
        functions.emplace_back(std::hash<string>()("Floor") ^ ArgumentHash(floor), floor);
    }
