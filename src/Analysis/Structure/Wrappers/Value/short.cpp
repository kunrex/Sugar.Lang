...
namespace Analysis::Structure::Wrappers
{
    ...
    void Short::BindGlobal()
    {
        ...
        const auto increment = new GeneratedOverload(SyntaxKind::Increment, this, "ldc.i2 1 add");
        increment->PushParameterType(this);
        increment->PushParameterType(this);
        overloads[0] = { SyntaxKind::Increment, increment };

        const auto decrement = new GeneratedOverload(SyntaxKind::Decrement, this, "ldc.i2 1 sub");
