...
namespace Analysis::Structure::Wrappers
{
    ...
    {
        characteristics["Max"] = new BuiltInConstant("Max", Describer::Public | Describer::Constexpr, &Instance(), new DoubleConstant(1.7976931348623157E+308));
        characteristics["Min"] = new BuiltInConstant("Min", Describer::Public | Describer::Constexpr, &Instance(), new DoubleConstant(-1.7976931348623157E+308));
        ...
        characteristics["Epsilon"] = new BuiltInConstant("Epsilon", Describer::Public | Describer::Constexpr, &Instance(), new FloatConstant(4.94065645841247E-324));
