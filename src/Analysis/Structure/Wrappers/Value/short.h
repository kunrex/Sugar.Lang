...
namespace Analysis::Structure::Wrappers
{
    class Short final : public DataTypes::BuiltInValueType, public Services::SingletonService, public virtual Core::Interfaces::IPrimitiveType
    {
        private:
            ...
            std::array<std::pair<unsigned long, const Core::Interfaces::IFunction*>, 4> implicitCasts;
            ...
            std::array<std::pair<Tokens::Enums::SyntaxKind, const Core::Interfaces::IBuiltInOverload*>, 19> builtInOverloads;
