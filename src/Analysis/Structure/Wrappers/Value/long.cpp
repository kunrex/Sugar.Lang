...
namespace Analysis::Structure::Wrappers
{
    ...
    void Long::BindGlobal()
    {
        ...
        const auto increment = new BuiltInOperation(SyntaxKind::Increment, this, "ldc.i8 1 add", nullptr);
        increment->PushParameterType(this);
        increment->PushParameterType(this);
        overloads.emplace_back(SyntaxKind::Increment, increment);

        const auto decrement = new BuiltInOperation(SyntaxKind::Decrement, this, "ldc.i8 1 sub", nullptr);
