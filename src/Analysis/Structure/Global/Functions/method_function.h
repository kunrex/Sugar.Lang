...
{
    class MethodFunction final : public MethodDefinition, public Core::Scoped, public Services::ConstantChild<Core::Interfaces::IUserDefinedType>
    {
        public:
    ...
    class GeneratedGetFunction final : public MethodDefinition, public Services::ConstantChild<Core::Interfaces::IUserDefinedType>
    {
        private:
    ...
    class BuiltInMethod final : public MethodDefinition, public Core::BuiltInFunction
    {
        public:
