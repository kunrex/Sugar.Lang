...
namespace ParseNodes::Functions::Creation
{
    class OperatorOverloadNode final : public KeywordFunctionNode
    {
        ...
        public:
            OperatorOverloadNode(const Describers::DescriberNode* describer, const ParseNode* type, const Tokens::Token& base, const Groups::CompoundDeclarationNode* parameters, const ParseNode* body, const Tokens::Token& keyword);
