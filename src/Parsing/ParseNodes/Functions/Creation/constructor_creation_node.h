...
namespace ParseNodes::Functions::Creation
{
    ...
    {
        public:
            ConstructorCreationNode(const Describers::DescriberNode* describer, const Groups::CompoundDeclarationNode* parameters, const ParseNode* body, const Tokens::Token& keyword);
