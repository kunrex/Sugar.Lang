...
namespace Tokens
{
    ...
    Token Separator::BoxOpenBracket(const unsigned long i) { return Create(i, SyntaxKind::Colon, "["); }
    Token Separator::BoxCloseBracket(const unsigned long i) { return Create(i, SyntaxKind::Semicolon, "]"); }

    Token Separator::FlowerOpenBracket(const unsigned long i) { return Create(i, SyntaxKind::Colon, "{"); }
    Token Separator::FlowerCloseBracket(const unsigned long i) { return Create(i, SyntaxKind::Semicolon, "}"); }
}